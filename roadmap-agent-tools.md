...
- Агент 37766e11-17e3-4367-a0c6-78d3e226103b имеет legacy-несоответствия в `allowed_tools` (снова всплыл snake_case), нужна повторная сверка всех агентов на предмет подобных пропусков.
